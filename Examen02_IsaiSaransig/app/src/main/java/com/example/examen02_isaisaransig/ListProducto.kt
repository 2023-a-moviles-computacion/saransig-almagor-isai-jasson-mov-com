...
class ListProducto : AppCompatActivity() {
    ...
    override fun onCreateContextMenu(
        ...
        productoSeleccionado = FirebaseSettings.arregloProductos[info.position]
    ...
    override fun onContextItemSelected(item: MenuItem): Boolean {
        ...
        return when (item.itemId){
            ...
            R.id.mi_eliminar -> {
                val descripcion = productoSeleccionado?.descripcion

                abrirDialogo {
                    COFirebase.firebase!!.deleteProducto(nombreTienda, adaptador, descripcion)
        ...
        registerForActivityResult(
            ...
            if(result.resultCode == Activity.RESULT_OK){
                if(result.data != null){
                    ...
                    val producto = Producto(descripcion,fechaElaboracion, precio, descuento )
                    COFirebase.firebase!!.updateProducto(
                        nombreTienda,
                        adaptador,
                        producto
                    )
